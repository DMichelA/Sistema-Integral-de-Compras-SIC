# Generated by Django 3.1.2 on 2021-01-13 04:32
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('especificaciones_tecnicas', models.CharField(blank=True, max_length=60)),
                ...
                ('ingresos_propios', models.DecimalField(decimal_places=2, default=0, max_digits=10)),
                ('recurso_fiscal', models.DecimalField(decimal_places=2, default=0, max_digits=10)),
                ('recurso_federal', models.DecimalField(decimal_places=2, default=0, max_digits=10)),
                ('presupues_total_anual', models.DecimalField(decimal_places=2, default=0, max_digits=10)),
                ('licitacion_publica', models.DecimalField(decimal_places=2, default=0, max_digits=10)),
                ('invitacion_personas', models.DecimalField(decimal_places=2, default=0, max_digits=10)),
                ('adjudicacion_directa', models.DecimalField(decimal_places=2, default=0, max_digits=10)),
                ('partidas_paaays', models.DecimalField(decimal_places=2, default=0, max_digits=10)),
                ('cal_enero', models.DecimalField(decimal_places=2, default=0, max_digits=10)),
                ('cal_febrero', models.DecimalField(decimal_places=2, default=0, max_digits=10)),
                ('cal_marzo', models.DecimalField(decimal_places=2, default=0, max_digits=10)),
                ('cal_abril', models.DecimalField(decimal_places=2, default=0, max_digits=10)),
                ('cal_mayo', models.DecimalField(decimal_places=2, default=0, max_digits=10)),
                ('cal_junio', models.DecimalField(decimal_places=2, default=0, max_digits=10)),
                ('cal_julio', models.DecimalField(decimal_places=2, default=0, max_digits=10)),
                ('cal_agosto', models.DecimalField(decimal_places=2, default=0, max_digits=10)),
                ('cal_septiembre', models.DecimalField(decimal_places=2, default=0, max_digits=10)),
                ('cal_octubre', models.DecimalField(decimal_places=2, default=0, max_digits=10)),
                ('cal_noviembre', models.DecimalField(decimal_places=2, default=0, max_digits=10)),
                ('cal_diciembre', models.DecimalField(decimal_places=2, default=0, max_digits=10)),
