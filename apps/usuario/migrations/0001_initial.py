# Generated by Django 3.1.2 on 2020-11-21 08:18
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('descrip_general_bien', models.CharField(blank=True, default='Sin descripción', max_length=60, null=True)),
                ('espeficaciones_tecnicas', models.CharField(blank=True, max_length=60, null=True)),
                ('capitulo', models.IntegerField(choices=[('', 'Seleccionar...'), (2000, 2000), (3000, 3000), (5000, 5000)])),
                ('tipo', models.CharField(choices=[('Bien', 'Bien'), ('Servicio', 'Servicio')], default='Unspecified', max_length=15)),
                ...
                ('ingresos_propios', models.DecimalField(blank=True, decimal_places=2, default=0, max_digits=6, null=True)),
                ('recurso_fiscal', models.DecimalField(blank=True, decimal_places=2, default=0, max_digits=6, null=True)),
                ('recurso_federal', models.DecimalField(blank=True, decimal_places=2, default=0, max_digits=6, null=True)),
                ('presupues_total_anual', models.DecimalField(blank=True, decimal_places=2, default=0, max_digits=6, null=True)),
                ('licitacion_publica', models.DecimalField(blank=True, decimal_places=2, default=0, max_digits=6, null=True)),
                ('invitacion_personas', models.DecimalField(blank=True, decimal_places=2, default=0, max_digits=6, null=True)),
                ('adjudicacion_directa', models.DecimalField(blank=True, decimal_places=2, default=0, max_digits=6, null=True)),
                ('partidas_paaays', models.DecimalField(blank=True, decimal_places=2, default=0, max_digits=6, null=True)),
                ('cal_enero', models.DecimalField(blank=True, decimal_places=2, default=0, max_digits=6, null=True)),
                ('cal_febrero', models.DecimalField(blank=True, decimal_places=2, default=0, max_digits=6, null=True)),
                ('cal_marzo', models.DecimalField(blank=True, decimal_places=2, default=0, max_digits=6, null=True)),
                ('cal_abril', models.DecimalField(blank=True, decimal_places=2, default=0, max_digits=6, null=True)),
                ('cal_mayo', models.DecimalField(blank=True, decimal_places=2, default=0, max_digits=6, null=True)),
                ('cal_junio', models.DecimalField(blank=True, decimal_places=2, default=0, max_digits=6, null=True)),
                ('cal_julio', models.DecimalField(blank=True, decimal_places=2, default=0, max_digits=6, null=True)),
                ('cal_agosto', models.DecimalField(blank=True, decimal_places=2, default=0, max_digits=6, null=True)),
                ('cal_septiembre', models.DecimalField(blank=True, decimal_places=2, default=0, max_digits=6, null=True)),
                ('cal_octubre', models.DecimalField(blank=True, decimal_places=2, default=0, max_digits=6, null=True)),
                ('cal_noviembre', models.DecimalField(blank=True, decimal_places=2, default=0, max_digits=6, null=True)),
                ('cal_diciembre', models.DecimalField(blank=True, decimal_places=2, default=0, max_digits=6, null=True)),
